...
$result = mysqli_query($koneksi, "SELECT * FROM senjata_tradisional");
?>
...
<head>
    ...
    <title>Senjata Tradisional - Tentang SulSel</title>
...
<body>
    ...
    <section class="hero-section">
        <h1 class="hero-title">Senjata Tradisional</h1>
        <img src="assets/senjata.png" alt="Hero Image">
    </section>
