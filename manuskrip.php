...
$result = mysqli_query($koneksi, "SELECT * FROM manuskrip");
?>
...
<head>
    ...
    <title>Manuskrip Kuno - Tentang SulSel</title>
...
<body>
    ...
    <section class="hero-section">
        <h1 class="hero-title">Manuskrip Kuno</h1>
        <img src="assets/manuskrip.png" alt="Hero Image">
    </section>
